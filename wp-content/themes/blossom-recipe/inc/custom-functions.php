...
function blossom_recipe_admin_notice() {
    ...
    $dismissnonce   = wp_create_nonce( 'blossom-recipe-update-notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=blossom-recipe-dashboard' ) ); ?>" class="button button-primary" style="text-decoration: none;"><?php esc_html_e( 'Go to the dashboard.', 'blossom-recipe' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?blossom-recipe-update-notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss','blossom-recipe' ); ?></a></strong></p>
                </div>
            </div>
            <style>
...
function blossom_recipe_ignore_admin_notice() {
    ...
    if ( isset( $_GET['blossom-recipe-update-notice'] ) && $_GET['blossom-recipe-update-notice'] === '1' && wp_verify_nonce( $_GET['_wpnonce'], 'blossom-recipe-update-notice' )) {
